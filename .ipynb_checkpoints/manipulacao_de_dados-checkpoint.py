...
# 
# Harder way
dataset_pre.columns[0]
dataset_pre.drop(columns=dataset_pre.columns[0], inplace=True)
dataset_pre.head()

dataset_pre.to_csv('./datasets/GasPricesinBrazil_2004-2019_preprocessed.csv')
